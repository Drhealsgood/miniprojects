...
[**Fibonacci Sequence**](https://github.com/Drhealsgood/miniprojects/blob/master/project_euler/euler.py) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.
...
[**Text to HTML Generator**](https://github.com/Drhealsgood/miniprojects/blob/master/text_projects/auto_markup/markup.py) – Converts text files into web HTML files and stylizes them. Great for making online documentation of standard text documentation.
